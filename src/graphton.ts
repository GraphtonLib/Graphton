...
async function main() {
  program
    ...
    .option(
      "-s, --exportSubscriptionFactoryAs [name]",
      'If you want a subscription factory, if no name provided "Subscription" will be used.',
      false
    )
    ...
    .option(
      "-d, --defineScalar <scalars...>",
      "Define custom scalars and their TS type. Use this if you don't want (some) scalars to be typed as string by default. (eg. --defineScalar Date=number Time=any)"
    )
