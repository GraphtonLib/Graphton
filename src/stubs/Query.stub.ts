...
class _t_QUERYCLASSNAME_t_ extends GraphtonBaseQuery<_t_ARGUMENTINTERFACENAME_t_> /*IF:ADDEXECUTOR*/ /*!implements!*/ /*IMPLEMENTS*/ /*ENDIF:ADDEXECUTOR*/ {
  ...
  protected returnType =
    /*IF:RETURNTYPEOBJECT*/ new /*ENDIF:RETURNTYPEOBJECT*/ _t_RETURNTYPEBUILDER_t_ /*IF:RETURNTYPEOBJECT*/() /*ENDIF:RETURNTYPEOBJECT*/;
   ...
   */
  async /*IGNORE*/ execute /*ENDIGNORE*/ /*EXECUTIONFUNCTIONNAME*/(
    requestOptions: RequestOptions = {}
  ): Promise<_t_QUERYCLASSNAME_t_Response> {
