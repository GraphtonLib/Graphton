...
abstract class GraphtonBaseReturnTypeBuilder {
    ...
    public withRelated(relatedType: string, buildFields: (type: GraphtonBaseReturnTypeBuilder) => void) {
    ...
    public withoutRelated(relatedType: string) {
